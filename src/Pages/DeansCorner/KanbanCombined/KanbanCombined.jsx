    ...
    <section className="p-section">
      ...
      <div className="link-list">
        <Link
          ...
          imgSrc={BS}
          href="#/kanban/BusinessSquad"
        />
        <Link
          heading="Cognizance"
          subheading="Learn what we do here"
          imgSrc={Cog}
          href="#/kanban/Cognizance"
        />
        <Link
          heading="Communiqa"
          subheading="Learn what we do here"
          imgSrc={Comm}
          href="#/kanban/Communiqa"
        />
        <Link
          heading="EcoBiz"
          subheading="Learn what we do here"
        ...
        <Link
          ...
          subheading="Learn what we do here"
          imgSrc={Grafitti}
          href="#/kanban/Graffiti"
        />
        <Link
          heading="Ignited Minds"
          subheading="Learn what we do here"
          imgSrc={IGM}
          href="#/kanban/IgnitedMinds"
        />
        <Link
          heading="Khel Ratna"
          subheading="Learn what we do here"
          imgSrc={KheR}
          href="#/kanban/KhelRatna"
        />
        <Link
          heading="Market Mavens"
          subheading="Learn what we do here"
          imgSrc={Mar}
          href="#/kanban/MarketMavens"
        />
        <Link
          heading="Money Matrix Club"
          subheading="Learn what we do here"
          imgSrc={Mon}
          href="#/kanban/MoneyMatrix"
        />
        <Link
          heading="Navrang"
          subheading="Learn what we do here"
